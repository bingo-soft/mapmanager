...
import GeometryFormat from "../../src/Domain/Model/Feature/GeometryFormat";
        ...
        MapManager.setSelectInteraction(map, {
            ...
            "select_callback": (features: FeatureCollection) => {
                if (features) {
                    ...
                    const featureNew: Feature = MapManager.createGeometryFromText(layer, textGeoJSON, GeometryFormat.GeoJSON, 4326);
